...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'your-email@gmail.com';        // ← CHANGE THIS to your Gmail
    $mail->Password = 'your-app-password-here';      // ← CHANGE THIS to your Gmail App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = 587;
    
    // Email settings
    $mail->setFrom('your-email@gmail.com', 'ETOK Car AC Services');
