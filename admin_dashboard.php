...
<head>
    ...
    <title>Admin Dashboard - ETOK Car AC Services</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="#" class="menu-link" data-page="history">
                    <i class="bi bi-clock-history"></i> History
                </a>
            </li>
            <li>
                <a href="#" class="menu-link" data-page="accounts">
                    ...
                    <div class="col mb-3">
                        <div class="stat-card">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6>Cancelled</h6>
                                    <h3 id="cancelledCount" class="text-danger">0</h3>
                                </div>
                ...
                <div class="modal-body">
                    <form id="addAccountForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="staffContact" placeholder="e.g., 09123456789" required>
                        </div>
                        <div class="mb-3">
